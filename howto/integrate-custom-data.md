...
If you are looking to integrate custom data from other apps, read [Integrate custom data from other apps](/howto/integrate-custom-data-from-other-apps.md).
...
> [Integrate the gender custom data](/howto/integrate-gender-custom-data.md) and
> [Integrate the handle name custom data](/howto/integrate-handlename-custom-data.md).
...
[Query specific data kinds](/howto/query-data-sets.md) and
...
adapter implementation. For more info, read [Sync contact data across devices](/howto/sync-contact-data.md).
...
- [`customdata-gender`](/howto/integrate-gender-custom-data.md)
- [`customdata-handlename`](/howto/integrate-handlename-custom-data.md)
- [`customdata-pokemon`](/howto/integrate-pokemon-custom-data.md)
- [`customdata-rpg`](/howto/integrate-rpg-custom-data.md)

Also provided are CRUD API integration with custom data from other apps that do have sync adapters;

- [`customdata-googlecontacts`](/howto/integrate-googlecontacts-custom-data.md)
