...
> If you want to update non-Profile Contacts, read [Update contacts](/howto/update-contacts.md).
...
> For more info, read [Query device owner Contact profile](/howto/query-profile.md).
...
The `ProfileUpdate` API supports custom data. For more info, read [Update custom data](/howto/update-custom-data.md).
