...
> For more info on `Contacts` API setup, read [How do I setup the Contacts API?](/contacts-android/howto/howto-setup-contacts-api.html)
...
read [How do I redact entities and API input and output in production?](/contacts-android/howto/howto-redact-apis-and-entities.html)
