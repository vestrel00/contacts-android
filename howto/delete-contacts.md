...
> If you want to delete the device owner Contact Profile, read [Delete the device owner Contact profile](/howto/delete-profile.md).

> If you want to delete a set of Data, read [Delete existing sets of data](/howto/delete-data-sets.md).
...
The `Delete` API supports custom data. For more info, read [Delete custom data](/howto/delete-custom-data.md).
