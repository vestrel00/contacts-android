...
> To update all kinds of data via Contacts/RawContacts, read [Update contacts](/howto/update-contacts.md).
...
The `DataUpdate` API supports custom data. For more info, read [Update custom data](/howto/update-custom-data.md).
