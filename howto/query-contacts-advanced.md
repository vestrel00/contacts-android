...
> If you want to query Data directly instead of Contacts, read [Query specific data kinds](/howto/query-data-sets.md).

> If you want to get the device owner Contact Profile, read [Query device owner Contact profile](/howto/query-profile.md).
...
To get a Contact by lookup key, read about [Contact lookup key vs ID](/howto/about-contact-lookup-key.md).
...
For more info, read [Blank contacts](/howto/about-blank-contacts.md).
...
> For more info, read [Query groups](/howto/query-groups.md).
...
> For more info, read [Convenience functions](/howto/convenience-functions.md).
...
The `Query` API supports custom data. For more info, read [Query custom data](/howto/query-custom-data.md).
