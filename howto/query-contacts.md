...
use the `include` function with custom data. For more info, read [Query custom data](/howto/query-custom-data.md).
...
read [Query contacts (advanced)](/howto/query-contacts-advanced.md).
