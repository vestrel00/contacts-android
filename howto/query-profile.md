...
> [Query contacts (broad)](/howto/query-contacts.md) and
...
The `ProfilQuery` API supports custom data. For more info, read [Query custom data](/howto/query-custom-data.md).