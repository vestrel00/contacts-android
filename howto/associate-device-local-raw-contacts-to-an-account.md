...
> For more info on local RawContacts, read about [Local (device-only) contacts](/howto/about-local-contacts.md).

> For more info on syncing, read [Sync contact data across devices](/howto/sync-contact-data.md).
