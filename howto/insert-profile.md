...
> If you want to create/insert non-Profile Contacts, read [Insert contacts](/howto/insert-contacts.md).
...
The `ProfileInsert` API supports custom data. For more info, read [Insert custom data into new or existing contacts](/howto/insert-custom-data.md).
