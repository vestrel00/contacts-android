...
[How do I link/unlink Contacts?](/howto/howto-link-unlink-contacts.html)
...
[How does contact data get synced across devices?](/howto/howto-sync-contact-data.html)
...
Read more in [How do I integrate custom data?](/howto/howto-integrate-custom-data.html)
...
[How do I query for Accounts?](/howto/howto-query-accounts.html)
...
For more info, read [How do I integrate custom data from social media?](/howto/howto-integrate-custom-data-from-social-media.html)
...
[How do I use some miscellaneous extension functions to make my life easier?](/howto/howto-use-miscellaneous-extensions.html)

To look into the actual Contacts Provider tables, read [How do I debug the Contacts Provider tables?](/howto/howto-debug-contacts-provider-tables.html)
