...
[How do I link/unlink Contacts?](/contacts-android/howto-link-unlink-contacts.md).
...
[How does contact data get synced across devices?](/contacts-android/howto-sync-contact-data.md).
...
Read more in [How do I integrate custom data?](/contacts-android/howto-integrate-custom-data.md).
...
[How do I query for Accounts?](/contacts-android/howto-query-accounts.md).
...
[How do I use some miscellaneous extension functions to make my life easier?](/contacts-android/howto-use-miscellaneous-extensions.md)