...
The `DataDelete` API supports custom data. For more info, read [How do I use delete APIs to delete custom data?](/contacts-android/howto/howto-delete-custom-data.html)
