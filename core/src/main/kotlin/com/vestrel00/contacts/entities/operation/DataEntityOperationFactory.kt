...
internal fun <T : MutableDataEntity> T.updateOperation(): ContentProviderOperation? =
...
private fun <T : MutableDataEntity> T.dataOperation(): AbstractDataOperation<T> = when (mimeType) {
