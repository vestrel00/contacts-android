...
internal fun Cursor.contactMapper(): EntityMapper<Contact> = ContactMapper(
    contactCursor(),
    optionsMapper()
)
...
internal fun Cursor.tempRawContactMapper(): EntityMapper<TempRawContact> =
    TempRawContactMapper(rawContactCursor())
